...
function updateGoal(prevGoal, newGoal) {
    ...
    if (requirementTree[newGoal]) {
        requirementTree[newGoal].requirements = requirementTree[newGoal].requirements.concat(requirementTree[oldGoal].requirements)
...
function deleteGoal(goal) {
    if (!$goals.includes("uncategorized")) {
        ...
        requirementTree['uncategorized'].requirements = requirementTree['uncategorized'].requirements.concat(requirementTree[goal].requirements)
    }
